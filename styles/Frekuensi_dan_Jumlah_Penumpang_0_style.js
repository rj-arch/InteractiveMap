...
var style_Frekuensi_dan_Jumlah_Penumpang_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jumlah_Penumpang");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 1.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.000000 && value <= 19.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 19.600000 && value <= 7325.000000) {
            style = [ new ol.style.Style({
